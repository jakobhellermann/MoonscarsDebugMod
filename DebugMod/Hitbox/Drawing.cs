...
public static class Drawing {
    ...
    public static void DrawUpperHalfCircle(Vector2 center, int radius, Color color, float width, bool antiAlias,
    ...
    public static void DrawLowerHalfCircle(Vector2 center, int radius, Color color, float width, bool antiAlias,
        int segmentsPerQuarter) {
        var rh = radius * 0.551915024494f;
